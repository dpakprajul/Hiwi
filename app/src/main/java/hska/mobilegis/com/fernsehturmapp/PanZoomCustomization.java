 ...
 */
public class PanZoomCustomization implements View.OnTouchListener {
    ...
    protected PanZoomCustomization(@NonNull XYPlot plot, Pan pan, Zoom zoom) {
        this.plot = plot;
        this.pan = pan;
        this.zoom = zoom;
    ...
    protected PanZoomCustomization(@NonNull XYPlot plot, Pan pan, Zoom zoom, ZoomLimit limit) {
        this.plot = plot;
        this.pan = pan;
        this.zoom = zoom;
    ...
    public static PanZoomCustomization attach(@NonNull XYPlot plot) {
        return attach(plot, Pan.BOTH, Zoom.SCALE);
    }


    public static PanZoomCustomization attach(@NonNull XYPlot plot, @NonNull Pan pan, @NonNull Zoom zoom) {
     ...
     * @return
     */
    public static PanZoomCustomization attach(@NonNull XYPlot plot, @NonNull Pan pan, @NonNull Zoom zoom, @NonNull ZoomLimit limit) {
        PanZoomCustomization pz = new PanZoomCustomization(plot, pan, zoom, limit);
