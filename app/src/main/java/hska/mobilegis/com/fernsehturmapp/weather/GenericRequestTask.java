...
//import com.example.slytk.turmapp.activities.WindOnly; //for WindOnly
...
public abstract class GenericRequestTask extends AsyncTask<String, String, TaskOutput> {
    ...
    Context context;
    WeatherMainActivity activity; //original: WeatherMainActivity activity
    public int loading = 0;

    public GenericRequestTask(Context context, WeatherMainActivity activity, ProgressDialog progressDialog) { //original: Context context, WeatherMainActivity activity, ProgressDialog progressDialog
