...
public class WeatherMainActivity extends BaseActivity implements LocationListener {
    ...
    private List<Weather> longTermWeather = new ArrayList<>(); // labelled Later
    private List<Weather> longTermTodayWeather = new ArrayList<>(); // labelled Today
    private List<Weather> longTermTomorrowWeather = new ArrayList<>(); // labelled Tomorrow
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceManager.setDefaultValues(this, R.xml.prefs, false); //prefs from xml folder
        ...
        setContentView(R.layout.activity_scrolling); //for scrolling up and down weather forecast
    ...
    public WeatherRecyclerAdapter getAdapter(int id) {
        ...
        if (id == 0) {
            ...
            weatherRecyclerAdapter = new WeatherRecyclerAdapter(this, longTermWeather); //labelled Later
        }
    ...
    private void aboutDialog() {
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("TurmWeather");
        final WebView webView = new WebView(this);
        String about = "<p>1.5</p>" +
                "<p>A lightweight, opensource weather app ;</p>" +
                "<p>originally developed by <a href='mailto:t.martykan@gmail.com'>Tomas Martykan</a> ; </p>" +
                "<p>adapted for use in the TurmApp by <a href='mailto:t.slytkamponsah@gmail.com'>Sylvester Tabi Kyei-Amponsah</a> ; </p>" +
                "<p>data provided by <a href='http://openweathermap.org/'>OpenWeatherMap</a>, under the <a href='http://creativecommons.org/licenses/by-sa/2.0/'>Creative Commons license</a> ; </p>"+
    ...
    private void updateTodayWeatherUI() {
        ...
        todayIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WeatherMainActivity.this, GraphActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_map) {
            Intent intent = new Intent(WeatherMainActivity.this, MapActivity.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(WeatherMainActivity.this, SettingsActivity.class);
            startActivity(intent);
        }
    ...
    public static String getWindDirectionString(SharedPreferences sp, Context context, Weather weather) { //wind arrow
        try {
